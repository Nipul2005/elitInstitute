...
function Footer() {
  return (
    <footer className="w-full py-5 bg-primary text-white text-center sm:px-10  px-4 space-y-2">
      <div className="w-full flex sm:flex-row flex-col justify-between items-start gap-y-8 gap-x-5 pb-5 relative h-auto">
        ...
        <div className="w-full flex flex-col justify-start items-start gap-y-2 h-full">
          <H3 text="Contact Us" />
          <span className="flex justify-start items-start gap-x-2 text-start mb-3">
