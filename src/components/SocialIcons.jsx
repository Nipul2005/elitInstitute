...
function SocialIcons() {
  return (
    <span className="flex gap-2 place-self-end ">
      <i className="ri-linkedin-line w-8 h-8 border border-white/20 flex justify-center items-center text-md hover:border-white transition-all ease cursor-pointer duration-200 hover:rounded-sm"></i>
      <a
